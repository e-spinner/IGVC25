...
from igvc.msg import Map, Position, Path
...
class Dashboard(Node):
  ...
  def __init__(self) -> None:
    ...
    try:
      ...
      template_dir = pkg_resources.resource_filename('igvc_dashboard', 'templates')
      static_dir = pkg_resources.resource_filename('igvc_dashboard', 'static')
